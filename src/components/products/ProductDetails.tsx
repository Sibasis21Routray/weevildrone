        ...
        <div className="space-y-12">
          ...
          {availableTabs.length > 0 && (
            <div>
              ...
              {/* Tab Content */}
              <div>
                {activeTab === 'general' && generalSpecifications && 
                  renderSpecificationCards(generalSpecifications, 'General Specifications')
                }
                
                {activeTab === 'power' && electricPowerSystem && 
                  renderSpecificationCards(electricPowerSystem, 'Power System')
                }
                
                {activeTab === 'performance' && performanceSpecifications && 
                  renderSpecificationCards(performanceSpecifications, 'Performance Specifications')
                }
                ...
                {activeTab === 'radar' && radarIntegration && 
                  renderSpecificationCards(radarIntegration, 'Radar Integration')
                }
                
                {activeTab === 'flight' && flightCharacteristics && 
                  renderSpecificationCards(flightCharacteristics, 'Flight Characteristics')
                }
              </div>
            </div>
          )}
            ...
            <div>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {communicationAndPerformance.communicationSystem && (
                  <div className="bg-white rounded-lg border border-gray-200">
                    <div className="bg-gray-900 px-4 py-3">
                      <h4 className="text-lg font-semibold text-white">Communication System</h4>
                    </div>
                    <div className="p-4">
                      <p className="text-gray-700 text-sm leading-relaxed">
                        {communicationAndPerformance.communicationSystem}
                ...
                {communicationAndPerformance.flightCapabilities && (
                  <div className="bg-white rounded-lg border border-gray-200">
                    <div className="bg-gray-900 px-4 py-3">
                      <h4 className="text-lg font-semibold text-white">Flight Capabilities</h4>
                    </div>
                    <div className="p-4">
                      <p className="text-gray-700 text-sm leading-relaxed">
                        {communicationAndPerformance.flightCapabilities}
